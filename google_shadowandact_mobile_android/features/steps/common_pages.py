...
# from pythonProject.google_shadowandact_mobile_android.features.environment import *
...
def verify_particular_page(driver, page):
    ...
    nav_btn = driver.find_element(
        By.XPATH,
        "//nav[@class='navbar']//div[1]//button[@type='button']")
    nav_btn.click()
    time.sleep(1)
...
def verify_number_of_articles(driver, temp_variable):
    ...
    # footer_adv_close_btn = driver.find_element(By.XPATH, "//img[@alt='close button']")
    # footer_adv_close_btn.click()
