Feature: On Androind Mobile Search for the S&A in google and browse the home page- BrowserStack

  Scenario: On Androind Mobile Search for the S&A in google and browse the home page- BrowserStack
