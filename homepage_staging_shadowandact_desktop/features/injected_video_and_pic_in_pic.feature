Feature: Verify presense of injected video and pic in pic for article link in staging.shadowandact.com - BrowserStack

  Scenario: Verify presense of injected video and pic in pic for article link in staging.shadowandact.com - BrowserStack
