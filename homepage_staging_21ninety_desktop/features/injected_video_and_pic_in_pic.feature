Feature: Verify presense of injected video and pic in pic for article link in staging.21ninety.com - BrowserStack

  Scenario: Verify presense of injected video and pic in pic for article link in staging.21ninety.com - BrowserStack
      Given the browser is launched and load the staging.21ninety.com app
