Feature: On Apple Mobile Search for the S&A in google and browse the home page- BrowserStack

  Scenario: On Apple Mobile Search for the S&A in google and browse the home page- BrowserStack
      Given on apple mobile the chrome browser is launched and navigating to the Google.com page
