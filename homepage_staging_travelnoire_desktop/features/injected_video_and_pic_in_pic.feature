Feature: Verify presense of injected video and pic in pic for article link in staging.travelnoire.com - BrowserStack

  Scenario: Verify presense of injected video and pic in pic for article link in staging.travelnoire.com - BrowserStack
      Given the browser is launched and load the staging.travelnoire.com app
