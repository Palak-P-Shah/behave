Feature: Verify presense of injected video and pic in pic for article link in staging.travelnoire.com on mobile android chrome - BrowserStack

  Scenario: Verify presense of injected video and pic in pic for article link in staging.travelnoire.com on mobile android chrome - BrowserStack
