Feature: Verify presense of injected video and pic in pic for article link in travelnoire.com - BrowserStack

  Scenario: Verify presense of injected video and pic in pic for article link in travelnoire.com - BrowserStack
      Given the browser is launched and load the travelnoire.com app
