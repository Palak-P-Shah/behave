Feature: Verify presense of injected video and pic in pic for article link in shadowandact.com - BrowserStack

  Scenario: Verify presense of injected video and pic in pic for article link in shadowandact.com - BrowserStack
      Given the browser is launched and load the shadowandact.com app
