Feature: Verify presense of injected video and pic in pic for article link in staging.afrotech.com - BrowserStack

  Scenario: Verify presense of injected video and pic in pic for article link in staging.afrotech.com - BrowserStack
      Given the browser is launched and load the staging.afrotech.com app
