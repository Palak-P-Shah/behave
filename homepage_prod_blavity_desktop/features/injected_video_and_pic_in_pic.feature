Feature: Verify presense of injected video and pic in pic for article link in blavity.com - BrowserStack

  Scenario: Verify presense of injected video and pic in pic for article link in blavity.com - BrowserStack
      Given the browser is launched and load the blavity.com app
